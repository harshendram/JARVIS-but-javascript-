JARVIS (A voice controlled AI like assistant inspired by the character of ironman)  is a fully functional voice controlled assistant made only using vanila Javascript(no libraries used).
